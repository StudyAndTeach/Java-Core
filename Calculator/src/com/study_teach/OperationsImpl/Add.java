...
public class Add implements Calculation,CalculatorConstants {
	...
	public Number calculate(double i,double j) {
		return i+j;
	}
	
	public Number calculate(int i,double j) {
		return i+j;
	}
	
	public Number calculate(double i,int j){
		return i+j;
	}
	
	public Number calculate(int i,int j) {
		return i+j;
	}
